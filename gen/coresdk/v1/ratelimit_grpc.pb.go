...
const (
	RateLimitService_CheckRateLimit_FullMethodName = "/coresdk.v1.RateLimitService/CheckRateLimit"
	RateLimitService_ResetRateLimit_FullMethodName = "/coresdk.v1.RateLimitService/ResetRateLimit"
)
...
func (c *rateLimitServiceClient) ResetRateLimit(ctx context.Context, in *ResetRateLimitRequest, opts ...grpc.CallOption) (*ResetRateLimitResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResetRateLimitResponse)
	err := c.cc.Invoke(ctx, RateLimitService_ResetRateLimit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRateLimitServiceServer) ResetRateLimit(context.Context, *ResetRateLimitRequest) (*ResetRateLimitResponse, error) {
...
func _RateLimitService_ResetRateLimit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RateLimitService_ResetRateLimit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RateLimitServiceServer).ResetRateLimit(ctx, req.(*ResetRateLimitRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RateLimitService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "coresdk.v1.RateLimitService",
	...
	Metadata: "coresdk/v1/ratelimit.proto",
}
